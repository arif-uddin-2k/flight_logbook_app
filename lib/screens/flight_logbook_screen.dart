                                    ...
                                    children: [
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  "${flightLogsList[index].flightDate.day.toString().padLeft(2, '0')}/${flightLogsList[index].flightDate.month.toString().padLeft(2, '0')}/${flightLogsList[index].flightDate.year}",
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .titleSmall,
                                                ),
                                      ...
                                      SizedBox(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              "${flightLogsList[index].totalFlyHour.inHours.remainder(24).toString().padLeft(2, '0')}:${flightLogsList[index].totalFlyHour.inMinutes.remainder(60).toString().padLeft(2, '0')}",
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .titleLarge,
                                            ),
